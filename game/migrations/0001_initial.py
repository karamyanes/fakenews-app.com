# Generated by Django 3.1.4 on 2021-05-11 18:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('join_successfuly', models.TextField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer_text', models.CharField(choices=[('true', 'true'), ('barely true', 'barely true'), ('false', 'false'), ('mostly true', 'mostly true'), ('pants on fire', 'pants on fire'), ('half true', 'half true')], max_length=256)),
