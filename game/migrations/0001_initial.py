# Generated by Django 3.1.4 on 2021-04-29 04:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer_text', models.CharField(choices=[('true', 'true'), ('barely true', 'barely true'), ('false', 'false'), ('mostly true', 'mostly true'), ('pants on fire', 'pants on fire')], max_length=256)),
